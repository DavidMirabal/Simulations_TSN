...
ax[0, 0].text(600, 1.5e48, r'$t_{ff}$', color='k')
ax[0, 0].axvline(3 * 960, alpha=0.6, color='k', ls='--', lw=1)
ax[0, 0].text(775 * 3, 1.5e48, r'$3t_{ff}$', color='k')
...
ax[0, 0].set_ylim(-8e47, 8e47)
ax[0, 0].grid()
ax[0, 0].set_ylabel(r'$E\,{\rm[J]}$')
...
ax[0, 1].text(600, 1.5e48, r'$t_{ff}$', color='k')
ax[0, 1].axvline(3 * 960, alpha=0.6, color='k', ls='--', lw=1)
ax[0, 1].text(775 * 3, 1.5e48, r'$3t_{ff}$', color='k')
